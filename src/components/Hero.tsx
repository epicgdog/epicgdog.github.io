  ...
  return (
    <section id="about" className="bg-[#ece2d2] px-4 pb-[78px] pt-[126px] sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="mb-[14px] text-6xl font-bold text-stone-900 sm:text-7xl">
          Gerard Consuelo
        </h1>
        <p className="mx-auto mb-[30px] max-w-2xl text-stone-600">
        ...
        <div className="flex justify-center gap-[14px]">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-gray-900 px-[14px] py-[6px] text-sm text-white transition-colors hover:bg-gray-800"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-[14px] py-[6px] text-sm text-white transition-colors hover:bg-blue-700"
          >
            <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg border-2 border-gray-300 px-[14px] py-[6px] text-sm text-gray-700 transition-colors hover:border-gray-900 hover:text-gray-900"
          >
