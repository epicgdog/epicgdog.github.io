      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="flex justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-lg hover:border-gray-900 hover:text-gray-900 transition-colors"
          >
